 ...
 * @author ichina
 */
public class EztHttpNet<Input> extends AsyncTask<Input, Exception, String> {
	...
	protected String doInBackground(Input... params1) {
		...
		String methodName=params1[2].toString();
		String result = HttpConnUtil.doPostNet(url,methodName, params);
		return result;
	}
