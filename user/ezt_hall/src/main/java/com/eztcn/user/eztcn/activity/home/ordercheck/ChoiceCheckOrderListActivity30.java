...
/**
 * 预约订单详情。
 * @author LX 2016-3-15上午10:08:57
 */
public class ChoiceCheckOrderListActivity30 extends FinalActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ViewUtils.inject(ChoiceCheckOrderListActivity30.this);
		loadTitleBar(true, "预约检查", null);
		adapter = new MyServiceCheckOrderAdapter30(mContext);
		setAdapter();
	}
	...
	private void setAdapter() {
		...
		choice_check_lv
				.setOnItemClickListener(ChoiceCheckOrderListActivity30.this);
	...
	private void initialData() {
		...
		if(BaseApplication.patient!=null){
			params.addBodyParameter("userId", BaseApplication.patient.getUserId()+ "");// Patinet_id
