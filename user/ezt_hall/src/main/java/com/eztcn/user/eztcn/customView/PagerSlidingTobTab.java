 ...
 */
@SuppressLint("NewApi")
public class PagerSlidingTobTab extends HorizontalScrollView {
	...
	public int index=0;// 选中下标

	public PagerSlidingTobTab(Context context) {
		this(context, null);
	}

	public PagerSlidingTobTab(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public PagerSlidingTobTab(Context context, AttributeSet attrs, int defStyle) {
		...
		a = context.obtainStyledAttributes(attrs,
				R.styleable.PagerSlidingTobTab);

		indicatorColor = a.getColor(
				R.styleable.PagerSlidingTobTab_pstsIndicatorColor,
				indicatorColor);
		underlineColor = a.getColor(
				R.styleable.PagerSlidingTobTab_pstsUnderlineColor,
				underlineColor);
		dividerColor = a.getColor(
				R.styleable.PagerSlidingTobTab_pstsDividerColor, dividerColor);
		indicatorHeight = a.getDimensionPixelSize(
				R.styleable.PagerSlidingTobTab_pstsIndicatorHeight,
				indicatorHeight);
		underlineHeight = a.getDimensionPixelSize(
				R.styleable.PagerSlidingTobTab_pstsUnderlineHeight,
				underlineHeight);
		dividerPadding = a.getDimensionPixelSize(
				R.styleable.PagerSlidingTobTab_pstsDividerPadding,
				dividerPadding);
		tabPadding = a.getDimensionPixelSize(
				R.styleable.PagerSlidingTobTab_pstsTabPaddingLeftRight,
				tabPadding);
		tabBackgroundResId = a.getResourceId(
				R.styleable.PagerSlidingTobTab_pstsTabBackground,
				tabBackgroundResId);
		shouldExpand = a.getBoolean(
				R.styleable.PagerSlidingTobTab_pstsShouldExpand, shouldExpand);
		scrollOffset = a.getDimensionPixelSize(
				R.styleable.PagerSlidingTobTab_pstsScrollOffset, scrollOffset);
		textAllCaps = a.getBoolean(
				R.styleable.PagerSlidingTobTab_pstsTextAllCaps, textAllCaps);
	...
	private class PageListener implements OnPageChangeListener {
		...
		public void onPageSelected(int position) {
			...
			((TextView) tabsContainer.getChildAt(index))
					.setTextColor(tabTextColor);
			((TextView) tabsContainer.getChildAt(position))
