 ...
 * @Description: 医说 界面
 */
public class OneThousandDoctorSayFragment extends BaseFragment {
    private RecyclerView mRecyclerView;
    private OneThousandDoctorRVAdapter mAdapter;
    private List<String> mDatas;
    public static OneThousandDoctorSayFragment newInstance() {
        OneThousandDoctorSayFragment fragment = new OneThousandDoctorSayFragment();
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        Log.i("fragment","一说onActivityCreated");
    }
