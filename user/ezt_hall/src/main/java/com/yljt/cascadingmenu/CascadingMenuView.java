...
public class CascadingMenuView extends LinearLayout {
	...
	private void init(final Context context) {
		...
		inflater.inflate(R.layout.new_view_region, this, true);
		...
		firstMenuListViewAdapter = new MenuItemAdapter(context, menuItem,
				R.drawable.new_choose_item_selected,
				R.drawable.new_choose_eara_item_selector);
		...
		thirdMenuListViewAdapter = new MenuItemAdapter(context, thirdItem,
				R.drawable.new_choose_item_right,
				R.drawable.new_choose_plate_item_selector);
