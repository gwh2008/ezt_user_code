...
public class TableUtils {
     ...
     * key: entityType.name
     */
    private static ConcurrentHashMap<String, xutils.db.table.Id> entityIdMap = new ConcurrentHashMap<String, xutils.db.table.Id>();

    /* package */
    static synchronized xutils.db.table.Id getId(Class<?> entityType) {
        ...
        xutils.db.table.Id id = new xutils.db.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        xutils.db.table.Id id = getId(entityType);
