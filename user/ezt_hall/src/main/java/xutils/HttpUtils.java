...
public class HttpUtils {
    ...
    public <T> HttpHandler<T> send(HttpRequest.HttpMethod method, String url, RequestParams params,
        ...
        params.addBodyParameter("appId", jni.getAppId());
        params.addBodyParameter("timestamp", System.currentTimeMillis() / 1000 + "");
        List<NameValuePair> list = params.getBodyParams();
        ...
        String signature = jni.MD5(getSign(map));
        params.addBodyParameter("signature", signature);
        Log.i("httputils",signature);
